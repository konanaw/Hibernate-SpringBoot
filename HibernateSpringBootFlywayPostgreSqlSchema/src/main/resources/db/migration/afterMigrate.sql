...
insert into book (isbn, title, author_id, id) values ('001-OG', 'Carrie', 11, 14);

alter sequence bookstore.author_generator_seq restart with 14;
alter sequence bookstore.book_generator_seq restart with 15;
